...
export default function AcceptInvitePage() {
  ...
  useEffect(() => {
    // Linkul de invitație setează sesiunea automat (detectSessionInUrl) — verificăm
    // că a apucat să se proceseze înainte de a afișa formularul de parolă.
  ...
  return (
    <div style={{ minHeight: "100vh", background: T.bg, display: "flex", alignItems: "center", justifyContent: "center" }}>
      <Card style={{ width: 404, padding: 36, borderRadius: RADIUS.xl, boxShadow: "0 4px 16px rgba(14,17,22,0.12)" }}>
        ...
        <p style={{ color: T.ink3, fontSize: 13.5, marginTop: 0, marginBottom: 24 }}>Ai fost invitat ca angajat — setează-ți parola</p>

        {checking && <p style={{ color: T.ink3, fontSize: 13 }}>Se verifică invitația...</p>}
